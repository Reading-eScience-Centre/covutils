...
describe("util/arrays methods", () => {
  ...
  describe("#indexOfNearest", () => {
    ...
    it("returns the index of the nearest value", () => {
      var ind = indexOfNearest(arr, 2.4)
      assert.equal(ind, 1)
    })
  })
})
